...
def main():
    ...
    # Команда поиска
    find_parser = subparsers.add_parser('find', help='Найти запись по названию сервиса')
    find_parser.add_argument('service', help='Название сервиса для поиска')
    
    # Команда проверки
    verify_parser = subparsers.add_parser('verify', help='Проверить пароль сервиса')
    verify_parser.add_argument('service', help='Название сервиса')
    
    # Команда инициализации базы данных
    subparsers.add_parser('init-db', help='Создать таблицы в базе данных')
